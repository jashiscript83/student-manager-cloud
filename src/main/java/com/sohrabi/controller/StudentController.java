...
public class StudentController {
	...
	public Department updateDepartment(@RequestBody Department department) {
		return studentService.updateDepartment(department);
	}

	@PutMapping("/update/subject")
	public Subject updateDepartment(@RequestBody Subject subject) {
		return studentService.updateSubject(subject);
	}
	...
	public List<Student> byDepartmentName(@RequestParam String deptId) {
